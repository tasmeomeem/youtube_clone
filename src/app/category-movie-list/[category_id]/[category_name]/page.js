...
export default function CategoryMovieList() {
    ...
    useEffect(() => {
        ...
        ApiService.get(`discover/movie`, {'page': page, 'with_genres': category_id})
            .then((data) => {
                    ...
                    <div className="row g-3">
                        <div className="col-12">
                            <div className="d-flex align-items-center justify-content-between">
                                <div className="h3">{helpers.toTitleCase(category_name)}</div>
                            </div>
                        </div>
